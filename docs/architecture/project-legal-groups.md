...
- `GET /api/legal` returns every project group to administrators. Members receive only groups for published public/member projects or projects with a signed/approved membership.
