...
> = {
  ...
  "/insights": {
    title: "Live insights.\nBetter decisions.",
    titleClassName: "insights-title",
    intro: "Custom dashboards give you a current view of the information driving your business, without relying on disconnected reports or outdated spreadsheets.",
    heading: "Turn your data into direction.",
    body: "OSai creates focused, easy-to-use dashboards around the questions your business needs to answer. We connect the right information, organize it clearly, and make important changes easier to recognize.",
    points: ["Business health", "Financial performance", "Operational efficiency", "Customer and market trends"],
